...
/// Página de login.
///
/// Responsável apenas por coletar as credenciais e delegar
/// a autenticação ao [LoginController].
  ...
  Future<void> _login() async {
    ...
    if (success) {
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (_) => PetSaveHomePage(
            userName: _controller.loggedUserName ??
...
// ── Layout para telas largas (≥ 800 px) ─────────────────────────────────────
        ...
        Expanded(
          child: Stack(
            ...
            children: [
              ...
              const Positioned(top: 32, left: 32, child: _Logo(light: true)),
              const Positioned(
                bottom: 40,
                left: 36,
                right: 36,
...
// ── Layout para telas estreitas (< 800 px) ───────────────────────────────────
...
// ── Conteúdo do formulário (reutilizável nos dois layouts) ───────────────────
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child:
                  const Icon(Icons.person_outline, color: orange, size: 28),
            ),
            ...
            const Text(
              ...
              style: TextStyle(
                  fontSize: 15, color: Color(0xFF6B6B6B), height: 1.5),
            ),
            const SizedBox(height: 36),
            // Campo e-mail
            const Text('Endereço de Email',
                style: TextStyle(
                    fontSize: 14,
              ...
              children: [
                ...
                TextButton(
                  onPressed: () => ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
                      content:
                          Text('Recuperação de senha ainda não implementada.'),
                    ),
                  ),
