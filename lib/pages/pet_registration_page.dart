...
class _PetRegistrationPageState extends State<PetRegistrationPage> {
  ...
  /// Abre a galeria do dispositivo (RQ04) e converte para base64.
  ...
  Future<void> _submit() async {
    ...
    final error = await _service.insertPetCard(
    ...
    Navigator.of(context).pop(true); // sinaliza sucesso para a tela anterior
  }
            ...
            child: Column(
              ...
              children: [
                ...
                TextFormField(
                  ...
                  validator: (v) {
                    if (v == null || v.isEmpty) return 'Informe um telefone';
