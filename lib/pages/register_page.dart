...
/// Página de cadastro de novos usuários (RF01 / RQ03).
///
/// Usa o Auth nativo do Supabase via [SupabaseService.registerUser].
...
class _RegisterPageState extends State<RegisterPage> {
  ...
  Future<void> _register() async {
    ...
    Navigator.pushReplacement(
      ...
      MaterialPageRoute(
        builder: (_) =>
            PetSaveHomePage(userName: _nameController.text.trim()),
      ),
    );
  }
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        cursorColor: _orange,
                        decoration:
                            _field('Senha', Icons.lock_outline_rounded),
                        validator: (v) {
                          if (v == null || v.isEmpty)
